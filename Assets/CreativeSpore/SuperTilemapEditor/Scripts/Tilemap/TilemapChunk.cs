        ...
        public static Color32 BlendColor(Color32 colorA, Color32 colorB, eBlendMode blendMode)
        {
            ...
            switch (blendMode)
            {
                ...
                case eBlendMode.AlphaBlending:
                    ...
                    if (outA > 0f)
                    {
                        colorA.r = (byte)((colorB.r * colorB.a + colorA.r * (255 - colorB.a)) / outA);
                        colorA.g = (byte)((colorB.g * colorB.a + colorA.g * (255 - colorB.a)) / outA);
                        colorA.b = (byte)((colorB.b * colorB.a + colorA.b * (255 - colorB.a)) / outA);
                    }
                    colorA.a = (byte)outA;
                    return colorA;
                case eBlendMode.Additive:
                    {
                        byte r = (byte)Mathf.Min(255, colorA.r + colorB.r);
                        byte g = (byte)Mathf.Min(255, colorA.g + colorB.g);
                        byte b = (byte)Mathf.Min(255, colorA.b + colorB.b);
                        return new Color32(r, g, b, colorA.a);
                    }
                case eBlendMode.Subtractive:
                    {
                        byte r = (byte)Mathf.Max(0, colorA.r - colorB.r);
                        byte g = (byte)Mathf.Max(0, colorA.g - colorB.g);
                        byte b = (byte)Mathf.Max(0, colorA.b - colorB.b);
                        return new Color32(r, g, b, colorA.a);
                    }
                case eBlendMode.Multiply:
                    {
                        byte r = (byte)(colorA.r * colorB.r / 255);
                        byte g = (byte)(colorA.g * colorB.g / 255);
                        byte b = (byte)(colorA.b * colorB.b / 255);
                        return new Color32(r, g, b, colorA.a);
                    }
                default:
                    return colorB;
