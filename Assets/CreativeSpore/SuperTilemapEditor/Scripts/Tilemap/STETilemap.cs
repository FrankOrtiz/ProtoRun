...
#region Public Methods
        ...
        public void SetTileColor(Vector2 vLocalPos, Color32 color, eBlendMode blendMode = eBlendMode.Normal)
        {
        ...
        /// <param name="color"></param>
        public void SetTileColor( int gridX, int gridY, Color32 color, eBlendMode blendMode = eBlendMode.Normal)
        {
        ...
        public void SetTileColor(Vector2 vLocalPos, TileColor32 tileColor, eBlendMode blendMode = eBlendMode.Normal)
        {
        ...
        /// <param name="c2">Top left corner</param>
        /// <param name="c3">Top right corner</param>
        public void SetTileColor( int gridX, int gridY, TileColor32 tileColor, eBlendMode blendMode = eBlendMode.Normal)
        {
