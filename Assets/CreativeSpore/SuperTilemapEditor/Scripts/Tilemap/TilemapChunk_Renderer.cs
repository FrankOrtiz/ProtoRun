...
namespace CreativeSpore.SuperTilemapEditor
{
    partial class TilemapChunk
    {
        ...
        public void SetTileColor(int locGridX, int locGridY, TileColor32 tileColor, eBlendMode blendMode = eBlendMode.Normal)
        {
            if (locGridX >= 0 && locGridX < m_width && locGridY >= 0 && locGridY < m_height)
            {
                ...
                if(blendMode == eBlendMode.Normal)
                    m_tileColorList[tileIdx] = tileColor;
                else
        ...
        public bool UpdateMesh()
        {
            ...
            if (gameObject.tag != ParentTilemap.gameObject.tag)
