...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public class MapPathFinding
    {
        ...
        List<MapTileNode> m_mapTileNodePool = new List<MapTileNode>();
        ...
        void ClearNodeDictionary()
        {
            m_mapTileNodePool.AddRange(m_dicTileNodes.Values);
        ...
        public MapTileNode GetMapTileNode( int idx )
        {
            ...
            if(!wasFound)
            {
                mapTileNode = GetOrCreateMapTileNode(idx);
